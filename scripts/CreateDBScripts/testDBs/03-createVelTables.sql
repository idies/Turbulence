...
---modified slightly for test db's 10/15/2018
...
set @createPartitionedTable = 'CREATE TABLE [dbo].[vel](
...
begin
	...
	*/
	...
	-- i think it should be > minLim and <= maxLim but need to double check, will fix --THAT IS CORRECT for range left
	--
