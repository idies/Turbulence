...
def index(request):
    ...
    if (request.method == "POST"):
        ...
        #context = {'datafield_list': datafield_list, 'dataset_list': dataset_list, 'download_link': download_link, 'form': form}
        #print 'if:'
        #print context
        ...
        #context =  { 'datafield_list': datafield_list, 'dataset_list': dataset_list, 'form': form}
        #print 'else:'
        #print context
    #return render(request, 'jhtdb/index.html', context)
