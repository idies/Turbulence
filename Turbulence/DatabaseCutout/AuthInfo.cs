...
namespace DatabaseCutout
{
    ...
    public class AuthInfo
    {
        ...
        protected AuthToken LoadUserFromDatabase(string tokenString)
        {
            ...
            String cString = "Server=gw01;Database=turbinfo;Asynchronous Processing=true;User ID=turbweb;Password=***REMOVED***;Pooling=true;Max Pool Size=250;Min Pool Size=20;Connection Lifetime=7200";
