...
<div id="centercolumnwide">
    ...
    <h2 class="titletext">Volume rendering of Ohmic electric field in MHD turbulence</h2>

    <iframe width="560"  height="315"  src="//www.youtube.com/embed/v3RjsdW7EHs" frameborder="0" allowfullscreen></iframe>

    <p class="videodescription">The data were generated by a simulation of the incompressible MHD equations on a space grid of 
        1,024^3 points. The magnetic Prandtl number is 1.  Animation shows a single snapshot from various viewing directions. 
        For more details, see Eyink et al. (Nature 2013, <a href="https://doi.org/10.1038/nature12128" target="_blank">doi:10.1038/nature1212</a>)</p>
</div>
