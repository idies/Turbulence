...
<body>
		...
		<div class="content">
			<div id="main">
				...
				<div id="centercolumn">
					...
					<h3>Download</h3>
					<h4><strong>C and Fortran Code: </strong>directly from <a href="https://github.com/idies/turblib/archive/master.zip">here</a> or <a href="https://github.com/idies/turblib">https://github.com/idies/turblib</a></h4>

					<p>
						This downloads a directory with sample Fortran (<tt>DEMO_turbf.f90, DEMO_mhdf.f90, DEMO_channelf.f90, DEMO_mixingf.f90, DEMO_getCutout.f90</tt>) and C (<tt>DEMO_turbc.c, DEMO_mhdc.c, DEMO_channelc.c, DEMO_mixingc.c, DEMO_getCutout.c</tt>) code, and has been tested under various versions of Mac OS X, Linux, FreeBSD and Windows (under Cygwin). The directory also includes several gSOAP wrapper functions that need not be modified. Executing '<em>make</em>' will build both the Fortran and C sample code.<br />
  ...
  <a href="/analysisdoc.aspx">analysis tools documentation</a>.
					...
					<p class="code">
						...
						<code>! ---- Temporal Interpolation Options ----<br />
  ...
  at the top of turbf.f90, mhdf.f90, channelf.f90 and mixingf.f90 for reference.  
					...
					<p class="code">
						<strong>C</strong><br />
						<code>enum SpatialInterpolation {<br />
  ...
  integer count, real(3,count) input, real(3,count) output)</code><br />
    ...
    integer count, real(3,count) input, real(9,count) output)</code><br />
						<br />
						<em>Example</em><br />
						<code>write(*, *) 'Velocity gradient at 10 particle locations'<br />
        ...
        int count, float input[count][3], float output[count][9])
						...
						<br />
						<em>Example</em><br />
						<code>getVelocityGradient (authtoken, dataset, time, FD4Lag4, temporalInterp, 10, points, result9);<br />
							for (p = 0; p &lt; 10; p++) {<br />
  ...
  result9[p][6], result9[p][7], result9[p][8]);<br />
    ...
    integer count, real(3,count) input, real(18,count) output)</code><br />
						<br />
						<em>Example</em><br />
						<code>write(*, *) 'Velocity Hessian at 10 particle locations'<br />
        ...
        int count, float input[count][3], float output[count][18])</code><br />
						<br />
						<em>Example</em><br />
						<code>getVelocityHessian (authtoken, dataset, time, FD4Lag4, temporalInterp, 10, points, result18);<br />
							for (p = 0; p &lt; 10; p++) {<br />
    ...
    integer count, real(3,count) input, real(3,count) output)</code><br />
						<br />
						<em>Example</em><br />
						<code>write(*, *) 'Velocity Laplacian at 10 particle locations'<br />
        ...
        int count, float input[count][3], float output[count][18])</code><br />
						<br />
						<em>Example</em><br />
						<code>getVelocityLaplacian (authtoken, dataset, time, FD4Lag4, temporalInterp, 10, points, result3);
  for (p = 0; p &lt; 10; p++) {<br />
    ...
    integer count, real(3,count) input, real(3,count) output)</code><br />
						<br />
						<em>Example</em><br />
						<code>write(*, *) 'Pressure gradient at 10 particle locations'<br />
        ...
        int count, float input[count][3], float output[count][3])
						...
						<br />
						<em>Example</em><br />
						<code>getPressureGradient (authtoken, dataset, time, FD4Lag4, temporalInterp, 10, points, result3);<br />
							for (p = 0; p &lt; 10; p++) {<br />
    ...
    integer count, real(3,count) input, real(6,count) output)</code><br />
        ...
        int count, float input[count][3], float output[count][6])
						...
						<br />
						<em>Example</em><br />
						<code>getPressureHessian(authtoken, dataset, time, FD4Lag4, temporalInterp, 10, points, result6);<br />
							for (p = 0; p &lt; 10; p++) {
