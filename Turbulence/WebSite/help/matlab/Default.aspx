		...
		<div class="content">
			<div id="main">
				...
				<div id="centercolumn">
					...
					<h3>Download</h3>
					<h4><strong>Matlab Code: </strong>directly from <a href="https://github.com/idies/turbmat/archive/master.zip">here</a> or <a href="https://github.com/idies/turbmat">https://github.com/idies/turbmat</a></h4>

					<p>
						This downloads a directory which constains the Matlab interface. Included are sample
    Matlab M-files (<tt>DEMO_turbm.m, DEMO_mhd.m, DEMO_channelm.m, DEMO_mixingm.m, DEMO_rotstrat.m, DEMO_transition_bl.m, DEMO_getCutout.m</tt>) that illustrate the basic functionality of the interface. These files may also be adapted to the end-user's needs. The directory also includes several gSOAP wrapper functions that need not be modified. The interface has been tested under newer installations of Matlab on various versions of Mac OS X, Linux, and Windows.
							<br />
    ...
    request and parse the results.
					...
					<ul>
						<p>
							...
							<li>Error handling is performed by the Matlab SOAP communication calls. If a
									<br />
								...
								will be terminated. We do not currently provide a method for explicit error
									<br />
								handling/catching.</li>
							<br />
							<li>When retrieving large amounts of data, the heap memory of Matlab's Java
									<br />
  ...
  <a href="/analysisdoc.aspx">analysis tools documentation</a>.
					...
					<p class="code">
						<code>
							...
							PCHIPInt = <font color="purple">'PCHIP'</font>; <font color="green">% Piecewise cubic Hermit interpolation in time</font><br />
							<br />
							...
							Lag8 = <font color="purple">'Lag8'</font>; <font color="green">% 8th order Lagrangian interpolation in space</font><br />
							<br />
    ...
    char <a href="/datasets.aspx">dataset</a>, real time,
							<br />
    ...
    char <a href="/datasets.aspx">dataset</a>, real time,
						...
						<em>Example</em><br />
						<br />
						<code>fprintf(<font color="purple">'Requesting velocity and pressure at 10 points...\n'</font>);
							<br />
    ...
    char <a href="/datasets.aspx">dataset</a>, real time,
						...
						<em>Example</em><br />
						<br />
						<code>fprintf(1,<font color="purple">'Velocity gradient at 10 particle locations...\n'</font>);<br />
							result9 = getVelocityGradient(authkey, dataset,  time, FD4Lag4, NoTInt, 10, points);<br />
							for i = 1:10
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">'%i : duxdx=%f'</font>, i, result9(1,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', duxdy=%f'</font>, result9(2,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', duxdz=%f'</font>, result9(3,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', duydx=%f'</font>, result9(4,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', duydy=%f'</font>, result9(5,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', duydz=%f'</font>, result9(6,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', duzdx=%f'</font>, result9(7,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', duzdy=%f'</font>, result9(8,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', duzdz=%f'</font>, result9(9,i));
							<br />
							end<br />
						</code>
					</p>
    ...
    char <a href="/datasets.aspx">dataset</a>, real time,
							...
							<br />
							&nbsp;&nbsp;integer count, real(3,count) input)</code><br />
						<br />

						<em>Example</em><br />
						<br />
						<code>fprintf(1,<font color="purple">'Velocity Hessian at 10 particle locations...\n'</font>);<br />
							result18 = getVelocityHessian(authkey, dataset,  time, FD4Lag4, NoTInt, 10, points);<br />
							for i = 1:10<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">'%i : d2uxdxdx=%f'</font>, i, result18(1,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uxdxdy=%f'</font>, result18(2,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uxdxdz=%f'</font>, result18(3,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uxdydy=%f'</font>, result18(4,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uxdydz=%f'</font>, result18(5,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uxdzdz=%f'</font>, result18(6,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uydxdx=%f'</font>, result18(7,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uydxdy=%f'</font>, result18(8,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uydxdz=%f'</font>, result18(9,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uydydy=%f'</font>, result18(10,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uydydz=%f'</font>, result18(11,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uydzdz=%f'</font>, result18(12,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uzdxdx=%f'</font>, result18(13,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uzdxdy=%f'</font>, result18(14,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uzdxdz=%f'</font>, result18(15,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uzdydy=%f'</font>, result18(16,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2uzdydz=%f'</font>, result18(18,i));
							<br />
    ...
    char <a href="/datasets.aspx">dataset</a>, real time,
						...
						<em>Example</em><br />
						<br />
						<code>fprintf(1,<font color="purple">'Velocity Laplacian at 10 particle locations...\n'</font>);<br />
    ...
    char <a href="/datasets.aspx">dataset</a>, real time,
						...
						<em>Example</em><br />
						<br />
						<code>fprintf(1,<font color="purple">'Pressure gradient at 10 particle locations...\n'</font>);<br />
    ...
    char <a href="/datasets.aspx">dataset</a>, real time,
						...
						<code>fprintf(1,<font color="purple">'Velocity hessian at 10 particle locations...\n'</font>);<br />
							...
							for i = 1:10<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">'%i: d2pdxdx=%f'</font>, i, result6(1,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2pdxdy=%f'</font>, result6(2,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2pdxdz=%f'</font>, result6(3,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2pdydy=%f'</font>, result6(4,i));
							<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">', d2pdydz=%f'</font>, result6(5,i));
							<br />
    ...
    char <a href="/datasets.aspx">dataset</a>, real time,
						...
						<em>Example</em><br />
						<br />
						<code>fprintf(1,<font color="purple">'Requesting forcing at 10 points...\n'</font>);<br />
							result3 = getForce(authkey, dataset,  time, Lag6, NoTInt, 10, points);<br />
							for i = 1:10<br />
							&nbsp;&nbsp;fprintf(1,<font color="purple">'%i: %f, %f, %f\n'</font>, i, result3(1,i),  result3(2,i),  result3(3,i));
							<br />
							end<br />
						</code>
					</p>
