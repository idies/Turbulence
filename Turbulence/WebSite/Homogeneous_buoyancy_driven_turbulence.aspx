		...
		<div class="content">
			<div id="main">
				...
				<div id="leftcolumn">
					...
					<br />
					<p>
						<img src="images/rstrt_0285_density.png" width="205" />
					</p>
				...
				<div id="centercolumn">
					...
					<p align="left" class="style20">Homogeneous buoyancy driven turbulence:</p>
					<p style="margin-left: 25px;">
						Simulation data provenance: Los Alamos National Laboratory using the LANL DNS code
            (see <a href="docs/README-HBDT.pdf" target="_blank">README-HBDT</a> for more details).
					</p>
					<ul>
						<li>Direct Numerical Simulation (DNS) of homogeneous buoyancy driven turbulence 
							in a domain size 2&pi; &times; 2&pi;  &times; 2&pi;, using 1,024<sup>3</sup> nodes.</li>
						...
						<li>The domain is triply periodic and the homogeneity of the fluctuating quantities is 
							ensured by imposing mean zero velocity and constant mean pressure gradient. 
							These conditions are similar to those encountered in the interior of the Rayleigh-Taylor mixing layer.</li>
						...
						<li>The 1015 time frames stored in the database cover both the buoyancy driven increase 
							inturbulence intensity as well as the buoyancy mediated turbulence decay. Each 
							time frame contains the density, 3 velocity components, and pressure at the grid 
							points. The frames are stored at a constant time interval of 0.04, which represents between 20 to 50 DNS time steps. </li>
						...
						<li>A file with the time history of 
							the Favre turbulent kinetic energy, k<sup>&tilde;</sup> = &lt;&rho;u<sub>i</sub><sup>''</sup>u<sub>i</sub><sup>''</sup>&gt; &frasl; 2&lt;&rho;&gt;, 
							Reynolds stresses, R<sub>ii</sub> = &lt;&rho;u<sub>i</sub><sup>''</sup>u<sub>i</sub><sup>''</sup>&gt; (no summation over i), 
							vertical mass flux, a<sub>v</sub> = &lt;&rho; u<sub>1</sub><sup>'</sup>&gt; &frasl; &lt;&rho;&gt;, 
							turbulent Reynolds number, Re<sub>t</sub> = k<sup>&tilde;2</sup> &frasl; &nu;&epsilon;, 
							eddy turnover time, &tau; = k<sup>&tilde;</sup> &frasl; &epsilon;, 
							kinetic energy dissipation, &epsilon;, density variance and density-specific volume correlation 
							can be found <a href="docs/hbdt/data1.txt" target="_blank">here</a>. 
							(Note: Until July 22, 2015, the time-history file that was posted on this site included 
							the total kinetic energy instead of the Favre turbulent kinetic energy. 
							The file posted since July 22, 2015 lists the Favre turbulent kinetic energy)</li>
						<li>Files with tables of the power spectra of density, 3 velocity components, 
							and mass flux can be downloaded at the following times: 
							<a href="docs/hbdt/spectra1.txt" target="_blank">6.56</a>, 
							<a href="docs/hbdt/spectra2.txt" target="_blank">11.4</a>, 
							<a href="docs/hbdt/spectra3.txt" target="_blank">15.0</a>, 
							<a href="docs/hbdt/spectra4.txt" target="_blank">20.0</a>,
							<a href="docs/hbdt/spectra5.txt" target="_blank">30.0</a>, and 
							<a href="docs/hbdt/spectra6.txt" target="_blank">40.0</a>.</li>
						<li>Files with tables of the density PDF can be downloaded for the following times: 
							<a href="docs/hbdt/pdf1.txt" target="_blank">0.0</a>, 
							<a href="docs/hbdt/pdf2.txt" target="_blank">6.56</a>, 
							<a href="docs/hbdt/pdf3.txt" target="_blank">11.4</a>,            
							<a href="docs/hbdt/pdf4.txt" target="_blank">15.0</a>, 
							<a href="docs/hbdt/pdf5.txt" target="_blank">20.0</a>,           
							<a href="docs/hbdt/pdf6.txt" target="_blank">30.0</a>, and 
							<a href="docs/hbdt/pdf7.txt" target="_blank">40.0</a>.</li>
					</ul>
