		...
		<div class="content">
			<div id="main">
				...
				<div id="centercolumn">
					...
					<p align="center">
						<span class="style29"><strong><font face="Arial, Helvetica, sans-serif">
							Welcome to the Johns Hopkins Turbulence Database (JHTDB) site</font></strong></span>
						<span class="style27"><font face="Arial, Helvetica, sans-serif"></font></span>
					</p>

					<p class="style34">
						<font size="2" face="Arial, Helvetica, sans-serif">
							This website is a portal to an Open Numerical Turbulence Laboratory that enables access to 
							multi-Terabyte turbulence databases. The data reside on several nodes and disks on our database 
							cluster computers and are stored in small 3D subcubes. 
							Positions are indexed using a Z-curve for efficient access.</font>
					</p>
					<p class="style34">
						<font size="2" face="Arial, Helvetica, sans-serif">
							Access to the data is facilitated by a Web services interface that permits 
							numerical experiments to be run across the Internet. We offer C, Fortran and 
							Matlab interfaces layered above <a href="instructionswebserv.aspx">Web services</a> 
							...
							being executed on the client's platform. <a href="webquery/query.aspx">Manual queries</a> for
							data at individual points and times via web-browser are also supported. Evaluation
					...
					<p align="center">
						<font size="2" color="red">Questions and comments?
            <a href="mailto:turbulence@lists.johnshopkins.edu">turbulence@lists.johnshopkins.edu</a></font>
					</p>
					<p align="center">
						<span class="style13">
