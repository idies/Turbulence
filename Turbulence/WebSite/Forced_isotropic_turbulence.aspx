		...
		<div class="content">
			<div id="main">
				...
				<div id="leftcolumn">
					...
					<br />
					<p>
						<img src="images/isotropic.jpg" width="205" />
					</p>
            ...
            (see <a href="docs/README-isotropic.pdf" target="_blank">README-isotropic</a> for more details).
					</p>
					<ul>
						...
						<li>Energy is injected by keeping constant the total energy in shells such that |k| is less or equal to 2. </li>
						<li>After the simulation has reached a statistical stationary state, 
							5,028 frames of data with 3 velocity components and pressure are stored in the database. 
							Extra time frames at the beginning and at the end have been added to be used for 
							temporal-interpolations. </li>
						<li>The Taylor-scale Reynolds number fluctuates around R<sub>&lambda;</sub> ~ 433.</li>
						<li>There is one dataset (&quot;coarse&quot;) with 5028 timesteps available, 
							for time t between 0 and 10.056 (the frames are stored at every 10 time-steps of the DNS). 
							Intermediate times can be queried using temporal-interpolation. </li>
						<li>There is another dataset (&quot;fine&quot;) that stores every single time-step of the DNS, 
							for testing purposes. Times available are for t between 0.0002 and 0.0198). </li>
						<li>A table with the time history of the total kinetic energy and Taylor-scale Reynolds number 
							as function of time can be downloaded from this <a href="ener_Re_time.txt" target="_blank">text file</a>. </li>
						<li>Radial spectrum E(k) averaged over time can be downloaded from this <a href="spectrum.txt" target="_blank">text file</a>.</li>
					</ul>
