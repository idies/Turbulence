    ...
    <div id="pagewrapper">
        <div class="content">
            <div id="main">
                ...
                <div id="leftcolumn">
                    <br><br /><br><br />
                    <p><img src="images/isotropic4096.jpg" width="205" /></p>
                    <div style="text-align: center">Forced Isotropic Turbulence Dataset on 4096<sup>3</sup> Grid:</div>
                </div>
                <div id="centercolumn">
                    <span class="style20">
                        Dataset
                    ...
                    <p align="left" class="style20"> Forced Isotropic Turbulence Dataset on 4096<sup>3</sup> Grid:</p>
                    <p style="margin-left:25px;">
                        Simulation data provenance: Georgia Tech DNS code
                        (see <a href="docs/README-isotropic4096.pdf" target="_blank">README-isotropic4096</a> for more details).
                    </p>
                    <ul>
        <li>Direct numerical simulation (DNS) using 4096<sup>3</sup> nodes.</li>
        <li> Navier-Stokes is solved using pseudo-spectral method.
...
<li>Domain: 2π x 2π x 2π</li>
<li>Grid: 4096<sup>3</sup></li>
    <li>Viscosity ν = 1.732 x 10<sup>-4</sup></li>
            <li>Number of snapshots available: 1</li>
            <li>RMS velocity: u’ = (2k/3)<sup>1/2</sup> = 1.56853</li>
            <li>Reynolds number Re<sub>λ</sub>= 610.57 </li>
            <li>Kolmogorov scale η = 1.3844 x 10<sup>-3</sup></li>
            <li><ε>L1/u’3 = 0.51 </li>
      </ul>      
