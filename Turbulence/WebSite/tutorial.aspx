			...
			<div id="main">
				...
				<div id="centercolumn">
					...
					<p align="left">
						<strong>
							<br />
							Sample assignment to explore basic statistics and coherent structures in transitional boundary layer using JHTDB </strong>
						<ul>
							<li><a href="download/JHTDB-Sample-assignment-2018.pdf">Assignment</a></li>
							<li><a href="download/JHTDB-Sample-assignment-SolutionSet-2018.pdf">Solution Set</a></li>
							<li><a href="download/JHTDB-Sample-assignment-scripts-2018.zip">Matlab scripts with solutions</a></li>
						</ul>
					</p>
