    ...
    <div id="pagewrapper">
        <div class="content">
            <div id="main">
                ...
                <div id="leftcolumn">
                    <br><br /><br><br />
                    <p><img src="images/rotstrat4096.jpg" width="205" /></p>
...
<li>Grid: 4096<sup>3</sup></li>
 <li>Number of snapshots available: 5</li>
    <li>Viscosity ν = 4 x 10<sup>-5</sup></li>
<li>Prandlt number Pr = ν/κ = 1</li>
<li>Brunt-Väisälä frequency N = 13.2</li>
<li>Inertial wave frequency f = 2.67</li>
<li>RMS velocity U<sub>o</sub> = 0.83</li>
<li>Scale of energy spectrum peak L<sub>o</sub> = 2π/k<sub>0</sub> = 2.5</li>
<li>Integral length scale L<sub>int</sub> = 2π ∫ EV(k)dk / ∫ kEV(k)dk = 2.6</li>
<li>Froude number Fr = U<sub>o</sub>/L<sub>o</sub>N = 0.0242</li>
<li>Rossby number Ro = U<sub>o</sub>/L<sub>o</sub>f = 0.12</li>
<li>Reynolds number Re = U<sub>o</sub>L<sub>o</sub>/ν = 5.4 x 104</li>
<li>Kinetic Energy Dissipation ε<sub>V</sub> = 0.0123</li>
<li>Potential Energy Dissipation ε<sub>P</sub> = 0.0077</li>
<li>Kolmogorov scale η = 1.51515 x 10-3</li>
<li>kmax η = 3.1</li>
      </ul>      
