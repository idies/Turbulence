...
namespace ImportData
{
    ...
    {
        int time_start = 50000;  // First time step to dataread
        int time_end = 50000;    // Last time step to dataread
        string data_dir = @"C:\Turb Data\";
        //string[] suffix = { "t04.s001.000" };
        string[] suffix = { "u", "v", "w" };
        string user = "kalin";
        string dbname = "turbulence";
        //string dbname = "turbload";
        string table = "velocity2";
        int[] resolution = { 513, 2049, 2049 };
        long firstbox = 0;
        long lastbox = new Morton3D(508, 1020, 1020).Key;
        int timeinc = 10;
        int timeoff = 0;
        int components = -1;
        int atomSize = 4;
        int edge = 0;
        string serverName = "winserv2k8";
        bool isDataLittleEndian = false;
        int numProcs = 2;

        ImportData(long firstbox, long lastbox, int numProcs, int timeoff)
        {
            this.time_start = 50000;  // First time step to dataread
            this.time_end = 50000;    // Last time step to dataread
            this.data_dir = @"C:\Turb Data\";
            //string[] suffix = { "t04.s001.000" };
            this.suffix = new string[] { "u", "v", "w" };
            this.user = "kalin";
            this.dbname = "turbulence";
            //string dbname = "turbload";
            this.table = "velocity2";
            this.resolution = new int[]{ 513, 2049, 2049 };
            this.timeinc = 10;
            this.timeoff = timeoff;
            this.components = -1;
            this.atomSize = 4;
            this.edge = 0;
            this.serverName = "winserv2k8";
            this.isDataLittleEndian = false;
        ...
        void SequentialImport()
        {
            ...
            FileCache cache = new FileCache(data_dir, suffix, resolution);
