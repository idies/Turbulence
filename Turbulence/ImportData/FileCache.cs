...
namespace ImportData
{
    ...
    public class FileCache
    {
        ...
        protected float timestepFormatting = 10000.0f;
        protected int pointDataSize = sizeof(double); // size of a single data point
        ...
        public FileCache(string data_dir, string[] suffix, int[] resolution, long headerSize)
        {
        ...
        public virtual void readFilesIntoByteArray(int timestep, long firstbox, long lastbox, int atomSize)
        {
            if ((this.timestep == timestep) && (this.firstbox == firstbox) && (this.lastbox == lastbox))
            {
                return;
        ...
        public virtual void readFiles(int timestep, long atom, int atomSize)
        {
        ...
        public virtual void ReadHeader(MemoryMappedViewStream stream)
        {
        ...
        {            
            int sourceIndex = (z * cache_dimensions[2] * cache_dimensions[1] + y * cache_dimensions[2] + x) * sizeof(double);
